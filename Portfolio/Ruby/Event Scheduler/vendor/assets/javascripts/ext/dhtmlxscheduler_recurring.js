...
function() {
    ...
    return r.rec_type || !t.rec_type || this._is_virtual_event(e) || (this._select_id = null),
        !0
...
function() {
    ...
    for (; n > i && i < e.end_date;) {
        ...
        if (d) a && t.push(d);
            ...
            if (o.text = e.text, o.start_date = i, o.event_pid = e.id, o.id = e.id + "#" + Math.ceil(l / 1e3), o.end_date = s, o.end_date = scheduler._fix_daylight_saving_date(o.start_date, o.end_date, e, i, o.end_date), o._timed = this.isOneDayEvent(o),
                !o._timed && !this._table_view && !this.config.multi_day) return;
