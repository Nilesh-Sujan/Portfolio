...
scheduler.attachEvent("onTemplatesReady", function() {
    function e(e, t, a, r) {
        for (var n = t.getElementsByTagName(e), i = a.getElementsByTagName(e), l = i.length - 1; l >= 0; l--) {
            var a = i[l];
            if (r) {
                var d = document.createElement("SPAN");
                d.className = "dhx_text_disabled", d.innerHTML = r(n[l]), a.parentNode.insertBefore(d, a), a.parentNode.removeChild(a)
        ...
        if (this.config.readonly_active) {
            for (var n = 0; n < i.length; n++)
                if ("recurring" == i[n].type) {
                    ...
                    break
                } for (var l = ["dhx_delete_btn", "dhx_save_btn"], d = [scheduler.config.buttons_left, scheduler.config.buttons_right], n = 0; n < l.length; n++)
                for (var s = l[n], o = 0; o < d.length; o++) {
                    for (var _ = d[o], c = -1, u = 0; u < _.length; u++)
                        if (_[u] == s) {
                            c = u;
                            break
                        } - 1 != c && _.splice(c, 1)
    ...
    scheduler._fill_lightbox = function() {
        ...
        if (this.config.readonly_active && (t.style.visibility = "",
            ...
            var r = this.getLightbox(),
                l = this._lightbox_r = r.cloneNode(!0);
            l.id = scheduler.uid(), e("textarea", r, l, function(e) {
                    return e.value
                }), e("input", r, l, !1), e("select", r, l, function(e) {
                    return e.options.length ? e.options[Math.max(e.selectedIndex || 0, 0)].text : ""
                }), r.parentNode.insertBefore(l, r), i.call(this, l), scheduler._lightbox && scheduler._lightbox.parentNode.removeChild(scheduler._lightbox), this._lightbox = l, scheduler.config.drag_lightbox && (l.firstChild.onmousedown = scheduler._ready_to_dnd),
                this.setLightboxSize(), l.onclick = function(e) {
